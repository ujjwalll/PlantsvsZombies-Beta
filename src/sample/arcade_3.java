...
public class arcade_3 extends Application {
...
//        gp.setMaxWidth(628.0);
        ...
        Timeline timeline_check_winner = new Timeline(
                new KeyFrame(Duration.millis(500), e -> {
                    if (z.size()==0){
                        ...
                        t_rc.interrupt();
                        t_peavz.interrupt();
                        Level_UP_4 lv4 =new Level_UP_4();
                            lv4.start(primaryStage);
                        //level change
                    }
                })
        );
        ...
        main_zombie.setCycleCount(10);
        main_zombie.play();
        timeline_check_winner.setDelay(Duration.seconds(120));
