...
public class arcade_4 extends Application {
    ...
    final Boolean wallnut_availability =true;
    final Boolean cherry_bomb_availability =true;
...
//        gp.setMaxWidth(628.0);
        ...
        Timeline timeline_check_winner = new Timeline(
                new KeyFrame(Duration.millis(500), e -> {
                    if (z.size()==0){
                        ...
                        t_rc.interrupt();
                        t_peavz.interrupt();
                        arcade_5 lv5 =new arcade_5();
                        try {
                            lv5.start(primaryStage);
        ...
        main_zombie.setCycleCount(15);
        main_zombie.play();
        timeline_check_winner.setDelay(Duration.seconds(160));
